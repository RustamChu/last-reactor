...
> **Тест 3:** игра «LAST REACTOR» - tower defense у последнего реактора: волны идут по flow-field, пушки честно перехватывают цели с упреждением. Python + pygame, ноль ассетов.
